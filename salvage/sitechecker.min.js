...
Printer.prototype.print=function(a,c){a.innerHTML="";if(0!==c.length)for(var b={},e=0;e<c.length;b={$jscomp$loop$prop$row_object$1:b.$jscomp$loop$prop$row_object$1},e++){var d=a.insertRow(0);b.$jscomp$loop$prop$row_object$1=new Row(d);d.onclick=function(a){return function(){a.$jscomp$loop$prop$row_object$1.click()}}(b);var f=d.insertCell(0),g=d.insertCell(1);d=d.insertCell(2);f.innerHTML=c[e].id;d.innerHTML=c[e].name;g.innerHTML=void 0===c[e].timestamp?"":c[e].timestamp}};var DataNormalizer=function(){};
